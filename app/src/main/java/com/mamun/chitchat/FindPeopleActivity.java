...
public class FindPeopleActivity extends AppCompatActivity {
    ...
    private RecyclerView finFriendList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        finFriendList=findViewById(R.id.find_friends_list);
        finFriendList.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
    ...
    protected void onStart() {
        ...
        finFriendList.setAdapter(firebaseRecyclerAdapter);
